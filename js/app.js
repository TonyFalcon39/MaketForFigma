(() => {
    ...
    function formFieldsInit(options = {
        ...
        let formsVals = document.querySelectorAll("._form");
        if (formsVals[0]) for (let i = 0; i < formsVals.length; i++) {
            let formsVal = formsVals[i];
            formsVal.addEventListener("input", (function(e) {
                const targetElement = e.target;
                if ("INPUT" === targetElement.tagName) if (formValidate.validateInput(targetElement)) targetElement.classList.add("add-disable"); else targetElement.classList.remove("add-disable");
                if (formsVal.querySelectorAll(".add-disable").length > 0) formsVal.querySelector("._btn").classList.add("_btn-disabled"); else formsVal.querySelector("._btn").classList.remove("_btn-disabled");
            }));
        }
    ...
    function formSubmit(options = {
        ...
        function formSent(form) {
            ...
            if (document.querySelector(".popup-sended")) {
 ...
 */
    ...
    if (inputMasks.length) flsModules.inputmask = Inputmask("+7 (999) 999 99 99", {
    ...
    function initSliders() {
        if (document.querySelector(".portfolio__slider")) new core(".portfolio__slider", {
            ...
            navigation: {
                ...
                disabledClass: "portfolio-button-disabled"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".clients__slider")) new core(".clients__slider", {
            ...
            navigation: {
                ...
                disabledClass: "clients-button-disabled"
            },
            on: {}
        });
    }
    ...
    if (hero) document.addEventListener("scroll", (function(e) {
        let heroBottom = hero.getBoundingClientRect().bottom;
        if (heroBottom < 80) headerWrap.classList.add("header-prefix"); else headerWrap.classList.remove("header-prefix");
        if (heroBottom < 0) headerWrap.classList.add("header-fix"); else headerWrap.classList.remove("header-fix");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
